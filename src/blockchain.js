    ...
    _addBlock(block) {
        ...
        return new Promise(async (resolve, reject) => {
           ...
           if(blockHash === 'undefined'){
               reject('There was an error calculating the hash of the block');
           } else {
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if(currentTime - messageTime > 60 * 5){
                reject('Time elapsed from the creation of the message is more than 5 minutes');
            } 
            ...
            let newBlock = new BlockClass.Block(starObj);
    ...
    getBlockByHash(hash) {
        ...
        return new Promise((resolve, reject) => {
           ...
           if (foundBlock !== 'undefined') {
               ...
               reject('The block with that hash could not be found');
           }
        });
    }
    ...
    getStarsByWalletAddress (address) {
        ...
        return new Promise((resolve, reject) => {
                self.chain
                    ...
                    .forEach(block => block.getBData().then(data => {
